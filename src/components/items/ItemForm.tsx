...
interface ItemFormProps {
	...
	onClose: () => void;
	onSave: (
		itemData: Omit<CollectibleData, "id" | "createdAt" | "updatedAt">,
	) => Promise<void>;
	isLoading?: boolean;
}
...
export const ItemForm: React.FC<ItemFormProps> = ({
	...
	const [capturedImageForDetection, setCapturedImageForDetection] = useState<
		string | null
	>(null);
	...
	const [pendingImageForDetection, setPendingImageForDetection] =
